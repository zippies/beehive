...
from .missionRunner import MissionRunner,StatusController
from . import url
...
def newMission():
    ...
    if request.method == "POST":
        try:
            ...
            runner = MissionRunner(mission.id,fakemachines,Config,statusController,request.form,request.files["file"])
            runner.start()
